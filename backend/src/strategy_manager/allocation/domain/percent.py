...
The balance passed in is the pool's TOTAL, not its free margin (owner decision
2026-09-15): a futures position's margin stays in the wallet, and sizing from
what is free would shrink every strategy that signals after another.
